...
def _render(snapshot: TrainingSnapshot) -> str:
    ...
    lines.extend(
        [
            ...
            f"          L7 split: FR={_format_number(snapshot.metrics.get('flow_ca_residual_ratio_layer7_flow_required'), 6)}    Normal={_format_number(snapshot.metrics.get('flow_ca_residual_ratio_layer7_normal'), 6)}    EMA={_format_number(snapshot.metrics.get('flow_ca_residual_ratio_layer7_ema'), 6)}    FR_EMA={_format_number(snapshot.metrics.get('flow_ca_residual_ratio_layer7_flow_required_ema'), 6)}    Normal_EMA={_format_number(snapshot.metrics.get('flow_ca_residual_ratio_layer7_normal_ema'), 6)}",
